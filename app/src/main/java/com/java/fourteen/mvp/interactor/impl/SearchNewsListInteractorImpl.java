...
import com.java.fourteen.mvp.interactor.SearchNewsListInteractor;
 ...
 */
public class SearchNewsListInteractorImpl implements SearchNewsListInteractor<List<NewsSummary>> {

//    private boolean mIsNetError;

    @Inject
    public SearchNewsListInteractorImpl() {
    }

    @Override
    public Subscription loadNews(final RequestCallBack<List<NewsSummary>> listener,
                                 String kw,
                                 int startPage) {
//        mIsNetError = false;
        ...
        return RetrofitManager.getInstance()
                .getSearchNewsListObservable(kw, startPage)
